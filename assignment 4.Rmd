---
title: "Assignment 4"
author: "Marco Palombo and Russel Fager"
date: "5/18/2022"
output: 
  html_document:
    code_folding: hide
...
ggplot(data = damages_fit, aes(x = warming, y = harm))+
  ...
  labs(x = "Warming (Degrees Celcius)", y = "Damages ($)")
...
geom_line(aes(x = implementation_cost, y = pol_a))+
  ...
  labs(x = "cost of policy implementation ($)", y = "net cost of policy ($)")
