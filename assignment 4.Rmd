...
# policy A option 1
discount_damages_a_1 <- sum(discount_damages(discount_rate,warming_policy$dam_a_1, warming$year, 2021))
# policy a option 2
discount_damages_a_2 <- sum(discount_damages(discount_rate,warming_policy$dam_a_2, warming$year, 2021))
# policy b
discount_damages_b <- sum(discount_damages(discount_rate,warming_policy$dam_b, warming$year, 2021))
...
damages_plot <- data_frame(implementation_cost = seq(0,1e14, by = 1e9)) %>% 
