...
#create function that sums the total discuntounted damages up to a given year for a certain discount rate.
SCC <- function(rate){
discount_damage_per_ton <- discounts(rate,warming$dif_per_ton, warming$year, 2021)
SCC <- sum(discount_damage_per_ton)
return(SCC)
}
```
